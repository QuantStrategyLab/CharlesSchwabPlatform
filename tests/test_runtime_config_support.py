...
class RuntimeConfigSupportTests(unittest.TestCase):
    ...
    def test_paper_command_consumer_requires_enabled_paper_runtime(self):
        with patch.dict(
            os.environ,
            {
                "RUNTIME_TARGET_JSON": runtime_target_json(
        ...
        self.assertTrue(settings.paper_execution_command_consumer_enabled)
    ...
    def test_reads_strategy_plugin_alert_email_config(self):
        with patch.dict(
            os.environ,
            {
                "RUNTIME_TARGET_JSON": runtime_target_json(SAMPLE_STRATEGY_PROFILE),
    ...
    def test_reads_strategy_plugin_alert_sms_config(self):
        with patch.dict(
            os.environ,
            {
                "RUNTIME_TARGET_JSON": runtime_target_json(SAMPLE_STRATEGY_PROFILE),
    ...
    def test_reads_strategy_plugin_alert_channels_and_push_config(self):
        with patch.dict(
            os.environ,
            {
                "RUNTIME_TARGET_JSON": runtime_target_json(SAMPLE_STRATEGY_PROFILE),
