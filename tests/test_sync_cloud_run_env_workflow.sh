...
grep -Fq 'env_pairs+=("SCHWAB_FEATURE_SNAPSHOT_FALLBACK_MODE=${SCHWAB_FEATURE_SNAPSHOT_FALLBACK_MODE}")' "$workflow_file"
grep -Fq 'remove_env_vars+=("SCHWAB_FEATURE_SNAPSHOT_FALLBACK_MODE")' "$workflow_file"
grep -Fq 'env_pairs+=("SCHWAB_FEATURE_SNAPSHOT_FALLBACK_CACHE_DIR=${SCHWAB_FEATURE_SNAPSHOT_FALLBACK_CACHE_DIR}")' "$workflow_file"
grep -Fq 'remove_env_vars+=("SCHWAB_FEATURE_SNAPSHOT_FALLBACK_CACHE_DIR")' "$workflow_file"
grep -Fq 'env_pairs+=("SCHWAB_FEATURE_SNAPSHOT_MAX_STALE_DAYS=${SCHWAB_FEATURE_SNAPSHOT_MAX_STALE_DAYS}")' "$workflow_file"
grep -Fq 'remove_env_vars+=("SCHWAB_FEATURE_SNAPSHOT_MAX_STALE_DAYS")' "$workflow_file"
...
grep -Fq 'env_pairs+=("SCHWAB_MARKET_SIGNAL_HANDOFF_INDEX_URI=${SCHWAB_MARKET_SIGNAL_HANDOFF_INDEX_URI}")' "$workflow_file"
grep -Fq 'remove_env_vars+=("SCHWAB_MARKET_SIGNAL_HANDOFF_INDEX_URI")' "$workflow_file"
grep -Fq 'env_pairs+=("SCHWAB_MARKET_SIGNAL_HANDOFF_MANIFEST_URI=${SCHWAB_MARKET_SIGNAL_HANDOFF_MANIFEST_URI}")' "$workflow_file"
grep -Fq 'remove_env_vars+=("SCHWAB_MARKET_SIGNAL_HANDOFF_MANIFEST_URI")' "$workflow_file"
grep -Fq 'env_pairs+=("SCHWAB_MARKET_SIGNAL_CONSUMPTION_AUDIT_URI=${SCHWAB_MARKET_SIGNAL_CONSUMPTION_AUDIT_URI}")' "$workflow_file"
grep -Fq 'remove_env_vars+=("SCHWAB_MARKET_SIGNAL_CONSUMPTION_AUDIT_URI")' "$workflow_file"
grep -Fq 'env_pairs+=("SCHWAB_MARKET_SIGNAL_CACHE_DIR=${SCHWAB_MARKET_SIGNAL_CACHE_DIR}")' "$workflow_file"
grep -Fq 'remove_env_vars+=("SCHWAB_MARKET_SIGNAL_CACHE_DIR")' "$workflow_file"
grep -Fq 'env_pairs+=("SCHWAB_MARKET_SIGNAL_REQUIRED=${SCHWAB_MARKET_SIGNAL_REQUIRED}")' "$workflow_file"
grep -Fq 'remove_env_vars+=("SCHWAB_MARKET_SIGNAL_REQUIRED")' "$workflow_file"
grep -Fq 'env_pairs+=("SCHWAB_MARKET_SIGNAL_FALLBACK_MODE=${SCHWAB_MARKET_SIGNAL_FALLBACK_MODE}")' "$workflow_file"
grep -Fq 'remove_env_vars+=("SCHWAB_MARKET_SIGNAL_FALLBACK_MODE")' "$workflow_file"
grep -Fq 'env_pairs+=("SCHWAB_MARKET_SIGNAL_MAX_STALE_DAYS=${SCHWAB_MARKET_SIGNAL_MAX_STALE_DAYS}")' "$workflow_file"
grep -Fq 'remove_env_vars+=("SCHWAB_MARKET_SIGNAL_MAX_STALE_DAYS")' "$workflow_file"
...
grep -Fq 'print(str(runtime_scheduler.get("timezone") or "America/New_York").strip())' "$workflow_file"
