...
I18N = {
    "zh": {
        ...
        "cash_label": "现金",
        "no_trades": "✅ 无需调仓",
        "risk_rejected": "⚠️ 策略风控拒绝：未提交订单",
        "risk_rejected_too_many_positions": "⚠️ 策略风控拒绝：目标标的数量超过适用风控限制，未提交订单",
        "separator": "━━━━━━━━━━━━━━━━━━",
        "signal_hold": "趋势持有",
        "signal_entry": "入场信号",
        "signal_reduce": "减仓信号",
        ...
        "sell_deferred_whole_share": "ℹ️ [卖出跳过] {symbol}：整数股不足 1 股，无需下单",
        "buy_deferred_whole_share": "ℹ️ [买入跳过] {symbol}：整数股不足 1 股，无需下单",
        ...
        "buy_deferred_insufficient_buying_power": "ℹ️ [买入跳过] {symbol}：可用购买力 ${buying_power} 不足 1 股限价 ${limit_price}，本轮保留现金",
        "market_data_unavailable": "⚠️ [行情暂不可用] {symbols} 缺少有效最新报价；本轮不下单，将在下个周期重试",
    ...
    "en": {
        ...
        "risk_rejected": "⚠️ Strategy risk rejected: no orders submitted",
        "risk_rejected_too_many_positions": "⚠️ Strategy risk rejected: target count exceeds applicable risk limit; no orders submitted",
        "separator": "━━━━━━━━━━━━━━━━━━",
        ...
        "sell_deferred_whole_share": "ℹ️ [Sell skipped] {symbol}: whole-share quantity rounds to 0; no order needed",
        "buy_deferred_whole_share": "ℹ️ [Buy skipped] {symbol}: whole-share quantity rounds to 0; no order needed",
        ...
        "buy_deferred_insufficient_buying_power": "ℹ️ [Buy skipped] {symbol}: buying power ${buying_power} is below 1-share limit price ${limit_price}; keeping cash this cycle",
        "market_data_unavailable": "⚠️ [Market data unavailable] {symbols} has no valid latest quote; no order was submitted and the next cycle will retry",
